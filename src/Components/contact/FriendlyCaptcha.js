...
const FriendlyCaptcha = forwardRef(({ sitekey, doneCallback, errorCallback, startMode }, widget) => {
    ...
    const _errorCallback = (err) => {
        ...
        console.log(`There was an error when trying to solve the FriendlyCaptcha: ${err}`);
    }
    ...
    return <div ref={container} class="frc-captcha" data-sitekey="FCMM00A8DEDCGSO8"></div>
})
